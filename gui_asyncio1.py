...
class gui(App):
	...
	def asyncRunIterator(self):
		self.hb_task = asyncio.ensure_future(self.hb.runIt())
		...
		return asyncio.gather(run_wrapper(), self.hb_task)

	
		
	def asyncRun(self):
		loop = asyncio.get_event_loop()
		loop.run_until_complete(self.asyncRunIterator())
		loop.close()
