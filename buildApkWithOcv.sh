...
echo "call"
ver=`date +%y%m%d`
p4a_build_ocv.sh $ver $app /tmp/$app /home/yoyo/Apps/ykpilot/icons/ico_sailboat_256_256.png
adb install  "/home/yoyo/.local/share/python-for-android/dists/API26_r21_3ocv__armeabi-v7a/bin/$app-0."$ver"-debug.apk"
